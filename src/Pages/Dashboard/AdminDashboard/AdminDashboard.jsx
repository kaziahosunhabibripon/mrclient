        ...
        <div className="grid md:grid-cols-3 gap-5">
          <div className="md:col-span-2">
            ...
            <div className="flex justify-between items-center border shadow p-5">
              <h4 className="text-lg font-bold text-webPrimary">
                Active Project - 12 ($840)
              </h4>

              {/* Select Active Projects Option */}
              <select
                className="border text-base font-medium outline-none px-5 py-1"
          ...
          <div>
            <div className="bg-[#F2F9FF] p-5">
              <h5 className="text-lg font-semibold text-webPrimary border-b border-webPrimary pb-2">
                This Month
              </h5>
